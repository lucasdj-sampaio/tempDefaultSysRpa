...
namespace COE000.Portal.NomeProjeto.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<IncriseUserModel> userManager, EmailService emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendAsync(Input.Email,
                    ...
                    @$"<p style='font-family:Calibri; font-size:16px; color:#1F1589;'>Olá, {Input.Email},<br>
                    Esqueceu sua senha?<br>
                    Clique no link abaixo para redefini-la!
                    <br><br>
                    <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Clique aqui!</a>
                    <br><br>
                    Se você não realizou essa solicitação, por favor ignore este email.<br>
                    Att,
                    </p>");
