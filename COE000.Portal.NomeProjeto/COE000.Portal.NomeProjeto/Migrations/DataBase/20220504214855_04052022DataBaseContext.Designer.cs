...
namespace COE000.Portal.NomeProjeto.Migrations.DataBase
{
    ...
    [Migration("20220504214855_04052022DataBaseContext")]
    partial class _04052022DataBaseContext
    {
            ...
            modelBuilder.Entity("COE334.Portal.FirstData.Models.Entity.HistoricModel", b =>
                {
                    b.HasOne("COE334.Portal.FirstData.Models.Entity.FunctionTypeModel", "FunctionType")
                        .WithOne("Historic")
                        .HasForeignKey("COE334.Portal.FirstData.Models.Entity.HistoricModel", "FunctionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("COE334.Portal.FirstData.Models.Entity.RpaCredentialModel", b =>
                {
                    b.HasOne("COE334.Portal.FirstData.Models.Entity.EnvironmentModel", "Environment")
                        ...
                        .HasForeignKey("COE334.Portal.FirstData.Models.Entity.RpaCredentialModel", "EnvironmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("COE334.Portal.FirstData.Models.Entity.StatusModel", b =>
                {
                    b.HasOne("COE334.Portal.FirstData.Models.Entity.EnvironmentModel", "Environment")
                        .WithOne("StatusModel")
                        .HasForeignKey("COE334.Portal.FirstData.Models.Entity.StatusModel", "EnvironmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("COE334.Portal.FirstData.Models.Entity.StatusTypeModel", "StatusTypeModel")
                        .WithOne("StatusModel")
                        .HasForeignKey("COE334.Portal.FirstData.Models.Entity.StatusModel", "StatusModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
